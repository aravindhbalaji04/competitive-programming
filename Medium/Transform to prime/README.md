<h2><a href="https://www.geeksforgeeks.org/problems/transform-to-prime4635/1?utm_source=geeksforgeeks&utm_medium=newui_home&utm_campaign=potd">Transform to prime</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of <strong>n</strong> integers. Find the <strong>minimum</strong> positive number to be inserted in array, so that sum of all elements of array becomes <strong>prime</strong>.</span></p>
